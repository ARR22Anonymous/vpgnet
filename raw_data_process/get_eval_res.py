...
if __name__ == '__main__':
    """
    Cases&Bags: python get_eval_res.py /data/xxx/jdsum/cases_bags/res/report_out/uniq_hypo.txt /data/xxx/jdsum/cases_bags/res/report_out/k_hypo.txt /data/xxx/jdsum/cases_bags/res/report_out/t_hypo.txt /data/xxx/jdsum/cases_bags/res/report_out/uniq_src.txt /data/xxx/jdsum/cases_bags/res/report_out/uniq_tgt.txt /data/xxx/jdsum/cases_bags/res/report_out/cases_bags.h_eval
    Home Appliances: python get_eval_res.py /data/xxx/jdsum/home_appliances/res/report_out/uniq_hypo.txt /data/xxx/jdsum/home_appliances/res/report_out/k_hypo.txt /data/xxx/jdsum/home_appliances/res/report_out/t_hypo.txt /data/xxx/jdsum/home_appliances/res/report_out/uniq_src.txt /data/xxx/jdsum/home_appliances/res/report_out/uniq_tgt.txt /data/xxx/jdsum/home_appliances/res/report_out/home_appliances.h_eval
    """
